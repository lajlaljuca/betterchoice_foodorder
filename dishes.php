        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/logo1.png" style="width:3em; height:2.5em;"alt=""> </a>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min 10,00 KM</a> </li>
...
?>									
                                        ...
                                        <div class="form-group row no-gutter">
                                            <div class="col-xs-8">
                                                 <input type="text" class="form-control b-r-0" value=<?php echo "KM".$item["price"]; ?> readonly id="exampleSelect1">
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>TOTAL</p>
                                        <h3 class="value"><strong><?php echo "KM ".$item_total; ?></strong></h3>
                                        <p>Free Shipping</p>
						...
						<?php  // display values and item of food/dishes
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >KM<?php echo $product['price']; ?></span>
        ...
        <footer class="footer">
            <div class="container">
            <li><a href="https://grupa5.000webhostapp.com/"><h5>Our Team</h5></a> </li> </br></br>
            <h5>Address: </h5><h5 style="color:red;">Zmaja od Bosne bb</h5> 
            <h5>Phone:</br> </br> <a href="tel:+080000012222">061266913</a></h5> </div>
    <!-- Modal -->
